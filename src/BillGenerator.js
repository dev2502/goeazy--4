...
function BillGenerator() {
 ...
 useEffect(() => {
  ...
  //to navigate to cutomer home page
  // const navigate = useNavigate();
  // const gotoHomeGB = () => navigate("/CustomerHomePage");
  return (
...
{/* for goto home button */}
{/* <div>
<button className='gotoHomeGB' onClick={gotoHomeGB}>Back to Login</button>
</div> */}
</div>
</>
